...
const ModelViewer = ({
  ...
  defaultRotationX = 0,
  defaultRotationY = 10,
  defaultZoom = 2.5, // ← Default zoom untuk ukuran yang pas
  minZoomDistance = 0.5, // ← Default min zoom
  maxZoomDistance = 10,
  enableMouseParallax = true,
  enableManualRotation = true,
  enableHoverRotation = false,
  enableManualZoom = true, // ← Default zoom dimatikan
  ambientIntensity = 0.5,
  keyLightIntensity = 1.2,
  fillLightIntensity = 0.6,
  rimLightIntensity = 0.8,
  environmentPreset = "sunset",
  autoFrame = false, // ← Default autoFrame aktif
  placeholderSrc,
  showScreenshotButton = false, // ← Default screenshot dimatikan
  fadeIn = true,
  autoRotate = false,
  ...
  return (
    ...
    >
      ...
      <Canvas
        ...
        camera={{ fov: 50, position: [0, 2, camZ], near: 0.01, far: 100 }}
